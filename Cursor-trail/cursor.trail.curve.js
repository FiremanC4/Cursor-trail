...
var circle = function(x, y, rad, fillC)
    ...
    var canvasTrail = document.getElementById("canvas-trail");
    var ctx = canvasTrail.getContext("2d");

    var x = canvasTrail.width/2;
    var y = canvasTrail.height/2;
...
canvasTrail.height = window.innerHeight;
            ...
            // ctx.fillText(colors, 10, 50);
            // ctx.fillText(typeof(colors), 10, 70);
